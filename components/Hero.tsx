  ...
  return (
    <section className="py-12 px-4 md:px-14">
      ...
      <div className="mt-12 flex flex-col xl:flex-row gap-6 xl:items-stretch xl:justify-between">
        <div className="flex flex-col xs:flex-row items-center justify-between bg-black rounded-xl overflow-hidden xl:min-w-[70%] 2xl:min-w-[80%]">
        ...
        <article className="bg-[#D8EFEF] w-full p-8 rounded-3xl xl:text-center mt-6 xl:mt-0 xl:min-w-[25%] py-10 2xl:min-w-[10%]">
